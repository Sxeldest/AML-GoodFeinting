...
public class MainActivity extends SampActivity {
    ...
    private void launchInstalledGameApk() {
        ...
        if (selectedServer == null || !selectedServer.isValid()) {
            Toast.makeText(this, "Add and select a server before opening the game.", Toast.LENGTH_LONG).show();
        ...
        try {
            ...
            Toast.makeText(this, "Install the News RP APK to enter the server.", Toast.LENGTH_LONG).show();
        }
    }
