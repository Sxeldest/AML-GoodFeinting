...
public class ServersFragment extends Fragment {
    ...
    private void bindServerItem(Context context,
        ...
        selectAction.setOnClickListener(v -> {
            ...
            if (!saved) {
                Toast.makeText(context, "Could not select server.", Toast.LENGTH_SHORT).show();
                return;
            }

            refreshContent();
            Toast.makeText(context, "Active server: " + option.getAddress(), Toast.LENGTH_SHORT).show();
        });
        ...
        removeAction.setOnClickListener(v -> {
            ...
            if (!removed) {
                Toast.makeText(context, "Could not remove server.", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            refreshContent();
            Toast.makeText(context, "Server removed: " + option.getAddress(), Toast.LENGTH_SHORT).show();
        });
