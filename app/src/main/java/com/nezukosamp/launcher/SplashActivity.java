package com.nezukosamp.launcher;
...
import com.nezukosamp.launcher.utils.Logcat;
import com.nezukosamp.launcher.utils.SignatureChecker;
...
public class SplashActivity extends AppCompatActivity implements GLSurfaceView.Renderer {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Nezuko SA-MP" + BuildConfig.VERSION_NAME, Toast.LENGTH_SHORT).show();
