...
@Obfuscate
public class Utils {
    public static File EXTERNAL_DIR = new File(Environment.getExternalStorageDirectory().getAbsolutePath().concat("/Android/data/com.nezukosamp.game/"));

    public static boolean status = true;
    public static boolean beta_status = false;

    public static String copyright = "Nezuko SA-MP\nCopyright © Dexsocy";
    public static String website = "";
    public static String web = "https://mobile.newgamersrp.com/";
    public static String update = web + "update.json";
    public static String discord = "https://discord.gg/UsTUA7GaC";
