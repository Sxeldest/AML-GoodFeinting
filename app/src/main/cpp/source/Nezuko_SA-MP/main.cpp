...
{
	LOGI("Initializing Nezuko_SA-MP library... Build time: " __DATE__ " " __TIME__);
	g_VM = vm;
...
__attribute__((constructor)) void constructor()
{
	...
	g_saHandle = dlopen("/data/data/com.nezukosamp.game/lib/libGTASA.so", RTLD_LAZY);
	g_sampHandle = dlopen("/data/data/com.nezukosamp.game/lib/libsamp.so", RTLD_LAZY);
